...
import no.nav.skanmothelse.helse.domain.Bruker;
...
import static no.nav.skanmothelse.helse.OpprettJournalpostPostboksHelseRequestMapper.FILTYPE_OCR;
import static no.nav.skanmothelse.helse.OpprettJournalpostPostboksHelseRequestMapper.FILTYPE_PDF;
import static no.nav.skanmothelse.helse.OpprettJournalpostPostboksHelseRequestMapper.FILTYPE_XML;
import static no.nav.skanmothelse.helse.OpprettJournalpostPostboksHelseRequestMapper.FNR;
import static no.nav.skanmothelse.helse.OpprettJournalpostPostboksHelseRequestMapper.JOURNALPOSTTYPE;
import static no.nav.skanmothelse.helse.OpprettJournalpostPostboksHelseRequestMapper.VARIANTFORMAT_OCR;
import static no.nav.skanmothelse.helse.OpprettJournalpostPostboksHelseRequestMapper.VARIANTFORMAT_PDF;
import static no.nav.skanmothelse.helse.OpprettJournalpostPostboksHelseRequestMapper.VARIANTFORMAT_XML;
import static no.nav.skanmothelse.helse.PostboksHelseEnvelopeTestObjects.ANTALL_SIDER;
import static no.nav.skanmothelse.helse.PostboksHelseEnvelopeTestObjects.BATCH_NAVN;
import static no.nav.skanmothelse.helse.PostboksHelseEnvelopeTestObjects.BRUKER_ID;
import static no.nav.skanmothelse.helse.PostboksHelseEnvelopeTestObjects.BRUKER_TYPE;
import static no.nav.skanmothelse.helse.PostboksHelseEnvelopeTestObjects.DATO_MOTTATT;
import static no.nav.skanmothelse.helse.PostboksHelseEnvelopeTestObjects.ENDORSERNR;
import static no.nav.skanmothelse.helse.PostboksHelseEnvelopeTestObjects.FILEBASENAME;
import static no.nav.skanmothelse.helse.PostboksHelseEnvelopeTestObjects.FYSISK_POSTBOKS;
import static no.nav.skanmothelse.helse.PostboksHelseEnvelopeTestObjects.MOTTAKSKANAL;
...
import static no.nav.skanmothelse.helse.PostboksHelseEnvelopeTestObjects.STREKKODE_POSTBOKS;
import static no.nav.skanmothelse.helse.PostboksHelseEnvelopeTestObjects.XML_FIL;
import static no.nav.skanmothelse.helse.PostboksHelseTema.PostboksHelse.PB_1411;
...
class OpprettJournalpostPostboksHelseRequestMapperTest {
	...
	void shouldMap() {
		...
		assertThat(hoveddokument.getDokumentVarianter())
				.extracting(DokumentVariant::filtype, DokumentVariant::variantformat, DokumentVariant::fysiskDokument, DokumentVariant::filnavn, DokumentVariant::batchnavn)
