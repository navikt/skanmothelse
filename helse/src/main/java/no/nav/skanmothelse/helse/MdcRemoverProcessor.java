...
import static no.nav.skanmothelse.mdc.MDCConstants.MDC_BATCHNAVN;
import static no.nav.skanmothelse.mdc.MDCConstants.MDC_CALL_ID;
import static no.nav.skanmothelse.mdc.MDCConstants.MDC_FILENAME;
import static no.nav.skanmothelse.mdc.MDCConstants.MDC_ZIP_ID;
